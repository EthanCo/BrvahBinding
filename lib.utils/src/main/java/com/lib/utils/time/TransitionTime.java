...
public class TransitionTime {
     ...
     * @return String
     */
    public static String convert(String time, String timeFormat) {
    ...
    /**
     * @param startTime 开始的事件
     * @return 1内天显示时间 ，1天外显示日期
     */
    public static String oneDateDistance(String startTime) {
        String startDate = convert(startTime, DateUtil.FORMAT_YMD);
        String currDate = DateUtil.getCurDateStr(DateUtil.FORMAT_YMD);
        if (!startDate.equals(currDate)) {
            return startDate;
        }
        return "今天" + convert(startTime, DateUtil.FORMAT_HM);
    }
}
